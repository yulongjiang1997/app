package md50ae44af97f71780edf6db7168bab0461;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Droid.BaiduSDKManager.DB.DBHelper, App1.Android", DBHelper.class, __md_methods);
	}
	...
	public DBHelper (android.content.Context p0, java.lang.String p1, android.database.sqlite.SQLiteDatabase.CursorFactory p2, int p3)
	{
		...
		if (getClass () == DBHelper.class)
			mono.android.TypeManager.Activate ("App1.Droid.BaiduSDKManager.DB.DBHelper, App1.Android", "Android.Content.Context, Mono.Android:System.String, mscorlib:Android.Database.Sqlite.SQLiteDatabase+ICursorFactory, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
	...
	public DBHelper (android.content.Context p0, java.lang.String p1, android.database.sqlite.SQLiteDatabase.CursorFactory p2, int p3, android.database.DatabaseErrorHandler p4)
	{
		...
		if (getClass () == DBHelper.class)
			mono.android.TypeManager.Activate ("App1.Droid.BaiduSDKManager.DB.DBHelper, App1.Android", "Android.Content.Context, Mono.Android:System.String, mscorlib:Android.Database.Sqlite.SQLiteDatabase+ICursorFactory, Mono.Android:System.Int32, mscorlib:Android.Database.IDatabaseErrorHandler, Mono.Android", this, new java.lang.Object[] { p0, p1, p2, p3, p4 });
	}
