...
namespace App1.Droid.BaiduSDKManager.Manager
{
    ...
    public class FaceEnvironment
    {
        ...
        // SDK配置参数
        public static readonly  float VALUE_BRIGHTNESS = 40f;
        public static readonly float VALUE_BLURNESS = 0.5f;
        public static readonly float VALUE_OCCLUSION = 0.5f;
        public static readonly int VALUE_HEAD_PITCH = 45;
        public static readonly int VALUE_HEAD_YAW = 45;
        public static readonly int VALUE_HEAD_ROLL = 45;
        public static readonly int VALUE_CROP_FACE_SIZE = 400;
        public static readonly float VALUE_NOT_FACE_THRESHOLD = 0.6f;
        public static readonly bool VALUE_IS_CHECK_QUALITY = false;
        public static readonly int VALUE_DECODE_THREAD_NUM = 2;
        public static readonly int VALUE_LIVENESS_DEFAULT_RANDOM_COUNT = 3;
        public static readonly int VALUE_MAX_CROP_IMAGE_NUM = 1;

        public static readonly float LIVENESS_RGB_THRESHOLD = 0.8f;
        public static readonly float LIVENESS_IR_THRESHOLD = 0.8f;
        public static readonly float LIVENESS_DEPTH_THRESHOLD = 0.8f;

        /**
         * 默认非人脸阈值
         */
        public static readonly float DEFAULT_NOT_FACE_THRESHOLD = 0.8f;

        /**
         * 默认最小人脸，小于此值的人脸将检测不出来
         */
        public static readonly int VALUE_MIN_FACE_SIZE = 80;
        ...
        // 设置是否检测质量, 开启后性能会下降
        private bool checkQuality = VALUE_IS_CHECK_QUALITY;
        // 左右摇头的角度阈值 比如-15~15
         ...
         */
        public void setCheckQuality(bool checkQuality)
        {
